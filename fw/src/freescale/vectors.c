...
extern void __reset_vector( void );
...
const tVectorTable __vector_table __attribute__ ((section(".vectortable"))) = {
	...
	{
			(tIsrFunc)__reset_vector,				/* 0x01  0x00000004   -   ivINT_Initial_Program_Counter  used by PE */
			...
			(tIsrFunc)Cpu_INT_BusFaultInterrupt,	/* 0x05  0x00000014   -   ivINT_Bus_Fault                unused by PE */
			(tIsrFunc)Cpu_INT_UsageFaultInterrupt,	/* 0x06  0x00000018   -   ivINT_Usage_Fault              unused by PE */
            ...
            (tIsrFunc)SysTick_ISR,  				/* 0x0F  0x0000003C   -   ivINT_SysTick                  unused by PE */
