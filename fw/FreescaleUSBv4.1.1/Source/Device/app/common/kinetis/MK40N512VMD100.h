...
**         LCD - Peripheral base pointer macro name has been changed from SLCD_BASE_PTR to LCD_BASE_PTR.
**         LCD - Peripheral register layout structure has been extended with 8-bit access to LCD waveform registers.
...
#if !defined(MCU_MK40N512VMD100)  /* Check if memory map has not been already included */
#define MCU_MK40N512VMD100

/* Check if another memory map has not been also included */
#if (defined(MCU_ACTIVE))
  #error MK40N512VMD100 memory map: There is already included another memory map. Only one memory map can be included.
...
#else /* #if !defined(MCU_MK40N512VMD100) */
