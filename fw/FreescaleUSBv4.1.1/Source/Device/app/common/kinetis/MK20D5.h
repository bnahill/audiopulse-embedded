...
#define DMAMUX0_CHCFG4                           DMAMUX_CHCFG_REG(DMAMUX_BASE_PTR,4)
#define DMAMUX0_CHCFG5                           DMAMUX_CHCFG_REG(DMAMUX_BASE_PTR,5)
#define DMAMUX0_CHCFG6                           DMAMUX_CHCFG_REG(DMAMUX_BASE_PTR,6)
#define DMAMUX0_CHCFG7                           DMAMUX_CHCFG_REG(DMAMUX_BASE_PTR,7)
#define DMAMUX0_CHCFG8                           DMAMUX_CHCFG_REG(DMAMUX_BASE_PTR,8)
#define DMAMUX0_CHCFG9                           DMAMUX_CHCFG_REG(DMAMUX_BASE_PTR,9)
#define DMAMUX0_CHCFG10                          DMAMUX_CHCFG_REG(DMAMUX_BASE_PTR,10)
#define DMAMUX0_CHCFG11                          DMAMUX_CHCFG_REG(DMAMUX_BASE_PTR,11)
#define DMAMUX0_CHCFG12                          DMAMUX_CHCFG_REG(DMAMUX_BASE_PTR,12)
#define DMAMUX0_CHCFG13                          DMAMUX_CHCFG_REG(DMAMUX_BASE_PTR,13)
#define DMAMUX0_CHCFG14                          DMAMUX_CHCFG_REG(DMAMUX_BASE_PTR,14)
#define DMAMUX0_CHCFG15                          DMAMUX_CHCFG_REG(DMAMUX_BASE_PTR,15)
...
typedef struct PDB_MemMap {
  ...
  uint32_t CHC1[1];                                /**< Channel n Control Register 1, array offset: 0x10, array step: 0x4 */
  uint32_t S[1];                                   /**< Channel n Status Register, array offset: 0x14, array step: 0x4 */
  uint32_t CHDLY0[1];                              /**< Channel n Delay 0 Register, array offset: 0x18, array step: 0x4 */
  uint32_t CHDLY1[1];                              /**< Channel n Delay 1 Register, array offset: 0x1C, array step: 0x4 */
...
#define PDB_CHC1_REG(base,index)                 ((base)->CHC1[index])
#define PDB_S_REG(base,index)                    ((base)->S[index])
#define PDB_CHDLY0_REG(base,index)               ((base)->CHDLY0[index])
#define PDB_CHDLY1_REG(base,index)               ((base)->CHDLY1[index])
...
/* CHC1 Bit Fields */
#define PDB_CHC1_EN_MASK                         0xFFu
#define PDB_CHC1_EN_SHIFT                        0
#define PDB_CHC1_EN(x)                           (((uint32_t)(((uint32_t)(x))<<PDB_CHC1_EN_SHIFT))&PDB_CHC1_EN_MASK)
#define PDB_CHC1_TOS_MASK                        0xFF00u
#define PDB_CHC1_TOS_SHIFT                       8
#define PDB_CHC1_TOS(x)                          (((uint32_t)(((uint32_t)(x))<<PDB_CHC1_TOS_SHIFT))&PDB_CHC1_TOS_MASK)
#define PDB_CHC1_BB_MASK                         0xFF0000u
#define PDB_CHC1_BB_SHIFT                        16
#define PDB_CHC1_BB(x)                           (((uint32_t)(((uint32_t)(x))<<PDB_CHC1_BB_SHIFT))&PDB_CHC1_BB_MASK)
/* S Bit Fields */
...
/* CHDLY0 Bit Fields */
#define PDB_CHDLY0_DLY_MASK                      0xFFFFu
#define PDB_CHDLY0_DLY_SHIFT                     0
#define PDB_CHDLY0_DLY(x)                        (((uint32_t)(((uint32_t)(x))<<PDB_CHDLY0_DLY_SHIFT))&PDB_CHDLY0_DLY_MASK)
/* CHDLY1 Bit Fields */
#define PDB_CHDLY1_DLY_MASK                      0xFFFFu
#define PDB_CHDLY1_DLY_SHIFT                     0
#define PDB_CHDLY1_DLY(x)                        (((uint32_t)(((uint32_t)(x))<<PDB_CHDLY1_DLY_SHIFT))&PDB_CHDLY1_DLY_MASK)
/* POEN Bit Fields */
...
#define PDB0_CH0C1                               PDB_CHC1_REG(PDB0_BASE_PTR,0)
#define PDB0_CH0S                                PDB_S_REG(PDB0_BASE_PTR,0)
#define PDB0_CH0DLY0                             PDB_CHDLY0_REG(PDB0_BASE_PTR,0)
#define PDB0_CH0DLY1                             PDB_CHDLY1_REG(PDB0_BASE_PTR,0)
...
#define PDB0_CHC1(index)                         PDB_CHC1_REG(PDB0_BASE_PTR,index)
#define PDB0_S(index)                            PDB_S_REG(PDB0_BASE_PTR,index)
#define PDB0_CHDLY0(index)                       PDB_CHDLY0_REG(PDB0_BASE_PTR,index)
#define PDB0_CHDLY1(index)                       PDB_CHDLY1_REG(PDB0_BASE_PTR,index)
