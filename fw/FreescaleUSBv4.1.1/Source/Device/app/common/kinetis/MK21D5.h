...
**
**     Reference manual:    K20P144M100SF2V2RM Rev. 1, Jan 2012
...
#if !defined(MCU_MK21D5)  /* Check if memory map has not been already included */
#define MCU_MK21D5
...
typedef enum {
  ...
  INT_DryIce                   = 71,               /**< DryIce Interrupt */
