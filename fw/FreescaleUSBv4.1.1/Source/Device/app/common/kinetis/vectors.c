...
#endif 
#if (defined MCU_MK20D5) || (defined MCU_MK20D7) || (defined MCU_MK40D7) || (defined MCU_MK40N512VMD100) ||  (defined MCU_MK53N512CMD100) ||  (defined MCU_MK21D5)
...
const __declspec(vectortable) tVectorTable __vector_table = { /* Interrupt vector table */
	...
	{	
/* Interrupt vector table for MK20 */
#ifdef MCU_MK20D5
...
/* Interrupt vector table for MK21 */
#elif (defined MCU_MK21D5)
        (tIsrFunc)__thumb_startup,         /* 0x01  0x00000004   -ivINT_Initial_Program_Counter  used by PE */
        (tIsrFunc)Cpu_INT_NMIInterrupt,    /* 0x02  0x00000008   -2   ivINT_NMI                      used by PE */
        (tIsrFunc)Cpu_INT_HardFaultInterrupt,/* 0x03  0x0000000C -1   ivINT_Hard_Fault               unused by PE */
...
#ifdef USED_PIT0
        (tIsrFunc)Timer_ISR,               /* 0x40  0x00000100   -ivINT_PIT0                         Timer_ISR    */
#else 
        (tIsrFunc)Cpu_Interrupt,           /* 0x40  0x00000100   -ivINT_PIT0                         Timer_ISR    */
#endif
#ifdef USED_PIT1
        (tIsrFunc)pit1_isr,                /* 0x41  0x00000104   -ivINT_PIT1                         pit1_isr    */
#else 
...
#ifdef _USB_BATT_CHG_APP_H_  
        (tIsrFunc)USBDCD_ISR,              /* 0x46  0x00000118   -ivINT_USBDCD                       USBDCD_ISR   */
#else
...
#ifdef _USB_BATT_CHG_APP_H_
        (tIsrFunc)VbusDetect_ISR,          /* 0x4B  0x0000012C   -ivINT_PORTA                        IRQ_ISR_PORTA */
#else
        (tIsrFunc)Cpu_Interrupt,           /* 0x4B  0x0000012C   -ivINT_PORTA                        IRQ_ISR_PORTA */
#endif
        (tIsrFunc)Cpu_Interrupt,           /* 0x4C  0x00000130   -ivINT_PORTB                        IRQ_ISR_PORTB */
        (tIsrFunc)IRQ_ISR_PORTC,           /* 0x4D  0x00000134   -ivINT_PORTC                        IRQ_ISR_PORTC */
        (tIsrFunc)Cpu_Interrupt,           /* 0x4E  0x00000138   -ivINT_PORTD                        IRQ_ISR_PORTD */
        (tIsrFunc)Cpu_Interrupt,           /* 0x4F  0x0000013C   -ivINT_PORTE                        IRQ_ISR_PORTE */
        (tIsrFunc)Cpu_Interrupt,           /* 0x50  0x00000140   -ivINT_Reserved80                   unused by PE */

/* Interrupt vector table for L2K */
#elif (defined MCU_MKL25Z4)
        (tIsrFunc)__thumb_startup,         /* 0x01  0x00000004   -   ivINT_Initial_Program_Counter  used by PE */
        (tIsrFunc)Cpu_INT_NMIInterrupt,    /* 0x02  0x00000008   -2   ivINT_NMI                     used by PE */
        (tIsrFunc)Cpu_INT_HardFaultInterrupt,/* 0x03  0x0000000C   -1   ivINT_Hard_Fault              unused by PE */
...
#if (defined(_SERIAL_BRIDGE_)|defined(_SERIAL_AGENT_))
        (tIsrFunc)UART0_ISR,           /* 0x1C  0x00000070   -   ivINT_UART0_ERR                unused by PE */
#else
...
#if((defined USED_PIT0)||(defined USED_PIT1))
...
#else
        (tIsrFunc)Cpu_Interrupt,                 /* 0x28  0x000000A0   -   ivINT_USB0                     USB_ISR      */
#endif
...
/* Interrupt vector table for other kinetis familys */
#else			
			(tIsrFunc)__thumb_startup,				/* 0x01  0x00000004   -   ivINT_Initial_Program_Counter  used by PE */
			(tIsrFunc)Cpu_INT_NMIInterrupt,			/* 0x02  0x00000008   -2   ivINT_NMI                     used by PE */
			(tIsrFunc)Cpu_INT_HardFaultInterrupt,	/* 0x03  0x0000000C   -1   ivINT_Hard_Fault              unused by PE */
