/*
** ###################################################################
**     Processor:           MK53N512CMD100
**     Compilers:           Freescale C/C++ for Embedded ARM
**                          IAR ANSI C/C++ Compiler for ARM
**     Reference manual:    K53P144M100SF2RM Rev. 4 Draft B, 7 Dec 2010
**     Version:             rev. 0.2, 2011-01-14
**
**     Abstract:
**         This header file implements peripheral memory map for MK53N512CMD100
**         processor.
**
...
/*! \file MK53N512CMD100.h */
/*! \version 0.2 */
/*! \date 2011-01-14 */
/*! \brief Peripheral memory map for MK53N512CMD100 */
/*! \detailed This header file implements peripheral memory map for MK53N512CMD100
      processor. */
...
#if !defined(MCU_MK53N512CMD100)  /* Check if memory map has not been already included */
#define MCU_MK53N512CMD100

/* Check if another memory map has not been also included */
#if (defined(MCU_ACTIVE))
  #error MK53N512CMD100 memory map: There is already included another memory map. Only one memory map can be included.
#endif /* (defined(MCU_ACTIVE)) */
#define MCU_ACTIVE

#include <stdint.h>

/*! Memory map version 0.2 */
#define MCU_MEM_MAP_VERSION 0x0002u
...
typedef enum {
  ...
  INT_Reserved48               = 48,               /*!< Reserved interrupt 48 */
  INT_Reserved49               = 49,               /*!< Reserved interrupt 49 */
  INT_Reserved50               = 50,               /*!< Reserved interrupt 50 */
...
/*! \addtogroup OPAMP_Peripheral OPAMP */
/*! \{ */

/*! OPAMP - Peripheral register structure */
typedef struct OPAMP_MemMap {
  uint8_t C0;                                      /*!< Control Register 0, offset: 0x0 */
  uint8_t C1;                                      /*!< Control Register 1, offset: 0x1 */
  uint8_t C2;                                      /*!< Control Register 2, offset: 0x2 */
} volatile *OPAMP_MemMapPtr;
...
#define OPAMP0_BASE_PTR                          ((OPAMP_MemMapPtr)0x400F5000u)
/*! Peripheral OPAMP1 base pointer */
#define OPAMP1_BASE_PTR                          ((OPAMP_MemMapPtr)0x400F5800u)
...
/* OPAMP0 */
#define OPAMP0_C0                                OPAMP_C0_REG(OPAMP0_BASE_PTR)
#define OPAMP0_C1                                OPAMP_C1_REG(OPAMP0_BASE_PTR)
#define OPAMP0_C2                                OPAMP_C2_REG(OPAMP0_BASE_PTR)
/* OPAMP1 */
#define OPAMP1_C0                                OPAMP_C0_REG(OPAMP1_BASE_PTR)
#define OPAMP1_C1                                OPAMP_C1_REG(OPAMP1_BASE_PTR)
#define OPAMP1_C2                                OPAMP_C2_REG(OPAMP1_BASE_PTR)

/*! \} */ /* end of group OPAMP_Register_Accessor_Macros */


/*! \} */ /* end of group OPAMP_Peripheral */
...
#if defined(__CC_ARM)
#define SPI_CTAR_REG(base,index2)                ((base)->_CTAR.CTAR[index2])
#define SPI_CTAR_SLAVE_REG(base,index2)          ((base)->_CTAR.CTAR_SLAVE[index2])
#else
...
#if defined(__CC_ARM)
#define SPI_PUSHR_REG(base)                      ((base)->_PUSHR.PUSHR)
#define SPI_PUSHR_SLAVE_REG(base)                ((base)->_PUSHR.PUSHR_SLAVE)
#else
...
/*! \addtogroup TRIAMP_Peripheral TRIAMP */
/*! \{ */

/*! TRIAMP - Peripheral register structure */
typedef struct TRIAMP_MemMap {
  uint8_t C0;                                      /*!< Control Register 0, offset: 0x0 */
} volatile *TRIAMP_MemMapPtr;
...
#define TRIAMP0_BASE_PTR                         ((TRIAMP_MemMapPtr)0x400F8000u)
/*! Peripheral TRIAMP1 base pointer */
#define TRIAMP1_BASE_PTR                         ((TRIAMP_MemMapPtr)0x400F8800u)
...
/* TRIAMP0 */
#define TRIAMP0_C0                               TRIAMP_C0_REG(TRIAMP0_BASE_PTR)
/* TRIAMP1 */
#define TRIAMP1_C0                               TRIAMP_C0_REG(TRIAMP1_BASE_PTR)

/*! \} */ /* end of group TRIAMP_Register_Accessor_Macros */


/*! \} */ /* end of group TRIAMP_Peripheral */
