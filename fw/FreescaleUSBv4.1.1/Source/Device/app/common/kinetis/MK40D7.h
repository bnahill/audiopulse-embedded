...
**     Version:             rev. 1.1, 2012-02-13
**
**     Abstract:
**         This header file implements peripheral memory map for MK40D7
**         processor.
**
 ...
 * @version 1.1
 * @date 2012-02-13
 * @brief Peripheral memory map for MK40D7
 *
 * This header file implements peripheral memory map for MK40D7 processor.
 */
...
#if !defined(MCU_MK40D7)  /* Check if memory map has not been already included */
#define MCU_MK40D7

/* Check if another memory map has not been also included */
#if (defined(MCU_ACTIVE))
  #error MK40D7 memory map: There is already included another memory map. Only one memory map can be included.
